                        ...
                        <tr class="{{ $loop->even ? 'bg-[#E8E6E6]' : 'bg-[#FFFFFF]' }}">
                            ...
                            <td class="px-4 py-2 border-b border-gray-300">
                                <img src="{{ $item->cover ? asset('uploads/covers/' . $item->cover) : asset('images/default-cover.jpg') }}"
                                    alt="Cover" class="w-16 h-10 object-cover rounded" />
                            </td>
                            ...
                            <td class="px-4 py-2 border-b border-gray-300">
                                @if ($item->instruktur_id === auth()->user()->id)
                                    <div class="flex gap-2">
                                        <a href="{{ route('instruktur.kursus.show', $item->id) }}"
                                        ...
                                        <a href="{{ route('instruktur.kursus.edit', $item->id) }}"
                                        ...
                                        <form action="{{ route('instruktur.kursus.destroy', $item->id) }}" method="POST"
